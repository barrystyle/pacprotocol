...
$(package)_patches=gcc_alignment_cast.patch missing_include.patch
...
define $(package)_preprocess_cmds
  ...
  patch -p1 $($(package)_extract_dir)/src/threshold.hpp < $($(package)_patch_dir)/missing_include.patch && \
